...
public class CRUD {
	...
	public static Cursos create(int curso) {
		...
		if (curso == 0) {
			...
			Fecha fecha_inscripcion_f =  func_fecha.crear_fecha_inscripcion_f("fecha_inscripcion_f", fecha_inscripcion_i );
			Fecha fecha_confirmacion_i =  func_fecha.crear_fecha_confirmacion_i("fecha_confirmacion_i", fecha_inscripcion_f);
			Fecha fecha_confirmacion_f =  func_fecha.crear_fecha_confirmacion_f("fecha_confirmacion_i", fecha_confirmacion_i);
				...
				if (curso instanceof Desplegamiento_web) {
					do {
						...
						case "fecha_f":
							...
							break;
						case "fecha_ultimas_plazas_i":
							((Desplegamiento_web) curso).set_fecha_ultimas_plazas_i(func_fecha.craar("fecha_ultimas_plazas_i"));
							break;
						case "fecha_ultimas_plazas_f":
							((Desplegamiento_web) curso).set_fecha_ultimas_plazas_f(func_fecha.craar("fecha_ultimas_plazas_f"));
							break;
						case "salir":
							salir = 10;
							break;

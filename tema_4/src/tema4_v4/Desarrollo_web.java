...
public class Desarrollo_web extends Cursos{
	...
	/*CONSTRUCTOR*/
	public Desarrollo_web(String iD_course, String titulo, String descripcion, String categoria, String dificultad, int precio, Fecha fecha_i, Fecha fecha_f, Fecha fecha_confirmacion_i2, Fecha fecha_confirmacion_f2, Fecha fecha_inscripcion_i2, Fecha fecha_inscripcion_f2) {

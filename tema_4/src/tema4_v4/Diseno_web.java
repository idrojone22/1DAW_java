...
public class Diseno_web extends Cursos{
	...
	/*CONSTRUCTOR*/
	public Diseno_web(String iD_course, String titulo, String descripcion, String categoria, String dificultad, int precio, Fecha fecha_i, Fecha fecha_f, Fecha f_c_promocion_i2, Fecha f_c_promocion_f2) {

...
public class Desplegamiento_web extends Cursos {
	...
	public Desplegamiento_web(String iD_course, String titulo, String descripcion, String categoria, String dificultad,
			Fecha fecha_i, Fecha fecha_f ,Fecha fecha_compra, Fecha fecha_ultimas_plazas_f, Fecha fecha_ultimas_plazas_i, int precioHora, int horasDias, int precio ) {
		super(iD_course, titulo, descripcion, categoria, dificultad,fecha_i, fecha_f, fecha_compra, precioHora, horasDias, precio);

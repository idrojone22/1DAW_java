...
public class CRUD {
	...
	public static Cursos create(int curso) {
		...
		if (curso == 1) {
			...
			objeto = new Diseno_web(ID_course, titulo, descripcion, categoria, dificultad, fecha_i, fecha_f, precioHora, horasDias, f_c_promocion_i, f_c_promocion_f,
					fecha_compra, precio);
		}
		if (curso == 2) {
	...
	public static Cursos update(Cursos curso) {
		...
		Object atributos_dw[] = { "ID_course", "titulo", "descripcion", "categoria", "dificultad", "fecha_i",
				...
				"fecha_inscripcion_f", "precioHora", "horasDias","fecha_compra","salir" };
		Object atributos_diw[] = { "ID_course", "titulo", "descripcion", "categoria", "dificultad", "fecha_i",
				"fecha_f", "f_c_promocion_i", "f_c_promocion_f","precioHora", "horasDias", "fecha_compra","salir" };
		Object atributos_despw[] = { "ID_course", "titulo", "descripcion", "categoria", "dificultad", "precio",
				"fecha_i", "fecha_f", "fecha_ultimas_plazas_i", "fecha_ultimas_plazas_f", "precioHora", " horasDias", "fecha_compra","salir" };
		int salir = 0;
